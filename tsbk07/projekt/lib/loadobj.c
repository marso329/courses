...
void DecomposeToTriangles(struct Mesh *theMesh)
{
	...
	int *newCoords=NULL, *newNormalsIndex=NULL, *newTextureIndex=NULL;
...
void DrawModel(Model *m, GLuint program, char* vertexVariableName, char* normalVariableName, char* texCoordVariableName)
{
	if (m != NULL)
	{
		...
		if (loc >= 0)
		{
			...
			ReportRerror((char *)"DrawModel", vertexVariableName);
}
		...
		if (normalVariableName!=NULL)
		{
			...
			if (loc >= 0)
			{
				...
				ReportRerror((char *)"DrawModel", normalVariableName);
		}
		...
		if ((m->texCoordArray != NULL)&&(texCoordVariableName != NULL))
		{
			...
			if (loc >= 0)
			{
				...
				ReportRerror((char *)"DrawModel", texCoordVariableName);
		}
...
void DrawWireframeModel(Model *m, GLuint program, char* vertexVariableName, char* normalVariableName, char* texCoordVariableName)
{
	if (m != NULL)
	{
		...
		if (loc >= 0)
		{
			...
			ReportRerror((char *)"DrawWireframeModel", vertexVariableName);
		...
		if (normalVariableName!=NULL)
		{
			...
			if (loc >= 0)
			{
				...
				ReportRerror((char *)"DrawWireframeModel", normalVariableName);
		}
		...
		if ((m->texCoordArray != NULL)&&(texCoordVariableName != NULL))
		{
			...
			if (loc >= 0)
			{
				...
				ReportRerror((char *)"DrawWireframeModel", texCoordVariableName);
		}
